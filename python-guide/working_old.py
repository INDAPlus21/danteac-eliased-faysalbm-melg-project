...
class NN:
    ...
    def forward_prop(self, train_ex):
        ...
        # print("hidden:", self.hidden_weights, "train:", train_ex) # ok so the hidden weights really DO make sense 2 and 2 
        ...
        print("activ1", activ_1, "output", self.output_weights) # aha! it's that the output also WEIGHTS THE TWO HIDDEN LAYER NEURONS DIFFERENTLY! 
        ...
        print("predicted output", predicted_output) # and THEN the predicted output holds the likelyhood for the different... TRAINING EXAMPLES :O 
    ...
    def back_prop(self, predicted_output, activ_1):
        ...
        # sigmoid !!! derivative for one layer "deeper down", for the output it's easier (and the sigmoid is already applied)
...
# print(losses)
# plot(losses)
# because they must be in columns... 
