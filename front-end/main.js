...
input.addEventListener("change", () => {
    ...
    file.arrayBuffer().then(buff => {
        ...
        /* const u8_file_to_send = new Uint8Array(buff);

        console.log({u8_file_to_send})
        console.log("calling process file!")
        const number_song = process_file(u8_file_to_send)
        ...
        const combined = combineTracks(alphanumeric[0], alphanumeric[1])
