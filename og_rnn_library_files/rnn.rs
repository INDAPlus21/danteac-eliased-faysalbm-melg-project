use linear_algebra2::{Vector, Matrix};
use std::fs;
...
impl RNN {
    pub fn new(input_size: usize, hidden_size: usize, output_size: usize) -> RNN {
        ...
        RNN {
            ...
            wxh: Matrix::with_random_normal(hidden_size, input_size, 0.0, standard_deviation) * factor,
            whh: Matrix::with_random_normal(hidden_size, hidden_size, 0.0, standard_deviation) * factor,
            why: Matrix::with_random_normal(output_size, hidden_size, 0.0, standard_deviation) * factor,
